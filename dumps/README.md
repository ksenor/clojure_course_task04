...
get the app created:
    ...
    $ heroku apps:create dumps
    Creating dumps... done, stack is cedar
    http://dumps.herokuapp.com/ | git@heroku.com:dumps.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://dumps.herokuapp.com deployed to Heroku

    To git@heroku.com:dumps.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://dumps.herokuap.com
    ["Hello" :from Heroku]
